...
function checkForm() {
    ...
    $.post("<%=basePath%>Admin/insertDevelopingPartymem.action",$("#fzdyAddForm").serialize(),function(data){
				alert("党员信息更新成功！");
...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <form action="Fzdy/Fzdy_AddFzdy.action" method="post" id="fzdyAddForm" name="form1">
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>培养时间:</td>
    <td width=70%><input type="text" readonly id="incubationTime"  name="incubationTime" onclick="setDay(this);"/></td>
  </tr>

  <tr>
    <td width=30%>培养人:</td>
    <td width=70%><input id="incubationPeople" name="incubationPeople" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>发展日期:</td>
    <td width=70%><input type="text" readonly id="developmentDate"  name="developmentDate" onclick="setDay(this);"/></td>
  </tr>
