...
<script language="javascript">
	...
	function checkForm() {
		...
		var xb = document.getElementById("jcxx.xb").value;
		if (xb == "") {
			alert('请输入性别!');
			return false;
		}
		var zw = document.getElementById("jcxx.zw").value;
		if (zw == "") {
			alert('请输入职务!');
			return false;
		}
		...
		<TBODY>
			<TR>
				<TD align="left" vAlign=top><s:form
						action="Jcxx/Jcxx_ModifyJcxx.action" method="post"
						...
						<table width='100%' cellspacing='1' cellpadding='3'
							...
							<tr>
								...
								<td width=70%><input id="jcxx.xb" name="jcxx.xb"
									type="text" size="6" value='' /></td>
							</tr>

							<tr>
								<td width=30%>出生日期:</td>
								<td width=70%><input type="text" readonly id="jcxx.csrq"
									name="jcxx.csrq" onclick="setDay(this);"
									value='' /></td>
							</tr>
							...
							<tr>
								...
								<td width=70%><input type="text" readonly id="jcxx.jcsj"
									name="jcxx.jcsj" onclick="setDay(this);" value=''/></td>
							</tr>
							<tr>
								<td width=30%>主要内容:</td>
							...
							<tr>
								...
								<td width=70%><input type="text" readonly id="jcxx.bprq"
									name="jcxx.bprq" onclick="setDay(this);" value=''/></td>
							</tr>
							...
							<tr>
								...
								<td width=70%><input type="text" readonly id="jcxx.sprq"
									name="jcxx.sprq" onclick="setDay(this);" value=''/></td>
							</tr>
							<tr>
								<td width=30%>审批意见:</td>
