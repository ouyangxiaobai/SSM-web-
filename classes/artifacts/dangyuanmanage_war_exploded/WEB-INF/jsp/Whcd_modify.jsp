...
<script language="javascript">
	...
	function checkForm() {
		...
		$.post("<%=basePath%>Admin/modifyEducation.action", $("#whcdModifyForm").serialize(), function(data) {
			alert("籍贯信息更新成功！");
		...
		<TBODY>
			<TR>
				<TD align="left" vAlign=top><form
						action="Whcd/Whcd_ModifyWhcd.action" method="post" name="form1"
						id="whcdModifyForm">
						<table width='100%' cellspacing='1' cellpadding='3'
							...
							<tr>
								...
								<td width=70%><input id="id" name="id" type="text"
									value="${education.id }" readOnly /></td>
							</tr>

							<tr>
								<td width=30%>文化程度:</td>
								<td width=70%><input id="educationLevel"
									name="educationLevel" type="text" size="20"
									value='${education.educationLevel }' /></td>
							</tr>
