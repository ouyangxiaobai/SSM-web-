...
%>
<HTML><HEAD><TITLE>添加入党积极分子</TITLE> 
<STYLE type=text/css>
BODY {
...
function checkForm() {
   ...
   // $.post("<%=basePath%>Admin/insertProActive.action",$("#rdjjfzAddForm").serialize(),function(data){
				alert("党员信息更新成功！");
...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <form action="insertProActive.action" method="post" id="rdjjfzAddForm" name="form1" enctype="multipart/form-data" onsubmit="return checkForm()">
