...
<script language="javascript">
	...
	function checkForm() {
		...
		$.post("<%=basePath%>Admin/modifyNativeplace.action", $("#jgxxModifyForm").serialize(), function(data) {
			alert("籍贯信息更新成功！");
						...
						<table width='100%' cellspacing='1' cellpadding='3'
							...
							<tr>
								...
								<td width=70%><input id="id" name="id" type="text"
									value="${nativeplace.id }" readOnly /></td>
							</tr>

							<tr>
								<td width=30%>籍贯:</td>
								<td width=70%><input id="nativeplace" name="nativeplace"
									type="text" size="20" value='${nativeplace.nativeplace }' /></td>
							</tr>
