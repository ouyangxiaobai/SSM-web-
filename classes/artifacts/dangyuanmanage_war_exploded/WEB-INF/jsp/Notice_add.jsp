...
<script language="javascript">
	...
	function checkForm() {
		...
		$.post("<%=basePath%>Notice/addNotice.action", $("#NoticeAddForm").serialize(), function(data) {
			alert("公告信息更新成功！");
			...
			<TR>
				<TD align="left" vAlign=top>
					<form action="Admin/insertNation.action" method="post"
						id="NoticeAddForm" name="form1">
						<table width='100%' cellspacing='1' cellpadding='3'
							class="tablewidth">

							<tr>
								<td width=30%>标题:</td>
								<td width=70%><input id="noticeTitle" name="noticeTitle" type="text"
									size="30" /></td>
							</tr>
<tr>
								<td width=30%>内容:</td>
								<td width=70%><input id="noticeContent" name="noticeContent" type="text"
									size="30" /></td>
							</tr>
							<tr bgcolor='#FFFFFF'>
